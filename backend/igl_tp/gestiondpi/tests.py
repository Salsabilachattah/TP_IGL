...
class TestSearchPatient(TestCase):
    ...
    def setUp(self):
        ...
        self.patient1 = Patient.objects.create(nss=123456789, user=self.user1, nom='John', prenom='Doe',
                                               date_de_naissance='1990-01-01')
        self.patient2 = Patient.objects.create(nss=987654321, user=self.user2, nom='Jane', prenom='Doe',
