...
# The location on the filesystem where files will be saved (relative to BASE_DIR)
...
SECRET_KEY = 'django-insecure-%i^a=fn=zcfjz&&=ykf@qn!v@dm7g5=^tedue6vxqdvbfift5m'
...
WSGI_APPLICATION = 'igl_tp.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'HOST':'mysql-igl-db.alwaysdata.net',
        'PORT':'3306'
    }
}
